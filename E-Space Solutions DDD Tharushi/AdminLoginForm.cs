...
{
    public partial class AdminLoginForm : Form // Add the data source and variables & Data source
    {
        ...
        private void btn_Login_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@AccountType", "Admin"); // Login_Account_Type is set to "Admin"
